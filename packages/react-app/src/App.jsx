...
function App(props) {
  ...
  // const Xx = useContractReader(readContracts, "DGToken", "totalSupply", [], localProviderPollingTime);
  const Xx = useContractReader(readContracts, "DGToken", "balanceOf", [address]);
